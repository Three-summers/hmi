        ...
        jobs: [
            {
                ...
                onClick: () => notify("info", "New Job", "Creating new job..."),
            },
            {
                id: "runJob",
            ...
            },
            {
                ...
                onClick: () =>
                    notify("warning", "Job Paused", "Process has been paused"),
            },
            {
                id: "stopJob",
        ...
        system: [
            {
                ...
                onClick: () =>
                    notify("info", "Refreshing", "System data refreshed"),
            },
            {
                id: "start",
            ...
            {
                id: "emergency",
                labelKey: "Emergency Stop",
                highlight: "alarm",
                onClick: () =>
                    showConfirm(
                        "Emergency Stop",
                        "This will immediately halt all operations. Continue?",
                        () =>
                            notify(
                                "error",
                                "EMERGENCY STOP",
        ...
        recipes: [
            {
                ...
                onClick: () =>
                    notify("info", "New Recipe", "Creating new recipe..."),
            },
            {
                id: "loadRecipe",
                labelKey: "Load Recipe",
                highlight: "processing",
                onClick: () =>
                    notify(
                        "success",
                        "Recipe Loaded",
                        "Recipe is ready for execution",
                    ),
            },
            {
                id: "editRecipe",
                ...
                onClick: () =>
                    notify("info", "Edit Mode", "Recipe editor opened"),
            },
            {
                id: "deleteRecipe",
        ...
        setup: [
            {
                ...
                highlight: "attention",
                onClick: () =>
                    notify("success", "Connected", "Connection established"),
            },
            {
                id: "disconnect",
                labelKey: "Disconnect",
                onClick: () =>
                    notify("warning", "Disconnected", "Connection closed"),
            },
            {
                id: "save",
        ...
        alarms: [
            {
                ...
                onClick: () => {
                    ...
                    notify(
                        "success",
                        "Alarms Acknowledged",
                        `${unackedCount} alarm(s) acknowledged`,
                    );
                },
            },
            {
                ...
                onClick: () =>
                    showConfirm(
                        "Clear Alarms",
                        "Clear all acknowledged alarms from history?",
                        () => {
                            clearAcknowledged();
                            notify(
                                "info",
        ...
        help: [
            {
                ...
                labelKey: "common.refresh",
                onClick: () =>
                    notify("info", "Refreshed", "Help content refreshed"),
            },
        ],
    };
